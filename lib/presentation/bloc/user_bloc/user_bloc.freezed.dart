...
abstract class _SignInEvent implements UserEvent {
...
class __$$SignUpEventImplCopyWithImpl<$Res>
    extends _$UserEventCopyWithImpl<$Res, _$SignUpEventImpl>
...
class _$SignUpEventImpl implements _SignUpEvent {
  ...
  @override
  String toString() {
    return 'UserEvent.signUp(email: $email, password: $password, name: $name)';
  }
...
abstract class _SignUpEvent implements UserEvent {
